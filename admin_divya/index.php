...
<?php
         ...
         Switch($golink)
	 {
		  ...
		  case "production_signup": include("./partials/production_signup.php");
          break;
		  
		  case "dispatch_signup": include("./partials/dispatch_signup.php");
          break;
		  
		  case "billing_signup": include("./partials/billing_signup.php");
          break;
