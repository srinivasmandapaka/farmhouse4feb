...
<section class="process fixed-top group">
	<div class="wrapper group">
        ...
        <div class="steps group">
                ...
                <div class="step-3 active"><a href="card4.php">Done<span class="left"></span></a></div>
        </div>
        
        <div class="pay-success group">
        	<img src="images/payment-success.png" class="text-center" />
        </div>
